...
if __name__ == "__main__":
    ...
    Scanner.Scanner("program_parse.txt", "tokens.in")
    c = GrammarConsole("g2.txt")
    # c.run()
    lr = LR(c.g)
    ...
    lr.print_tree(lr.parse_sequence('PIF.out', lr.compute_parsing_table(lr.canonical_collection())), 'out2.txt')
